...
Play listing is **free**. Internal testing is **36 (0.36.0)**. Closed testing Alpha **28 (0.28.0)** is in Google review (testers still on 25 until it clears). Six wall screenshots saved in Console. App content leftover forms are filled: no advertising ID, mediaPlayback FGS with demo video, exact alarm declared as alarm clock. Production is **not public**. Apply for production is disabled: 12+ closed testers opted in. Need those 12 to stay opted in for 14 days.
