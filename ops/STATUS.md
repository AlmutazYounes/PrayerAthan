...
Play listing is **free**. Internal testing is **33 (0.33.0)**. Closed testing Alpha **28 (0.28.0)** is in Google review (testers still on 25 until it clears). Six wall screenshots saved in Console. App content leftover forms are filled: no advertising ID, mediaPlayback FGS with demo video, exact alarm declared as alarm clock. Production is **not public**. Apply for production is disabled: 11 closed testers opted in. Needs 12 opted in for 14 days.
