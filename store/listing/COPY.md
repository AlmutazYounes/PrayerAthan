...
Paste-ready text for Play Console → Grow users → Store presence → Main store listing.

This copy is already in Console. Listing is free. Play shows Free. Do not write a price in the name or descriptions.

Do not claim official Makkah, Haramain, or ministry affiliation. Do not name a muezzin until the recordings are replaced with files you can ship. After that, describe the voice. Still no "official."

Category in Console is Lifestyle. Contact email is a listing field and is also in the full description.
...
- Privacy policy URL: https://almutazyounes.github.io/prayerathan-privacy/ (also in `DATA-SAFETY.md`)
