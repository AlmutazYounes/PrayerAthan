...
3. Or search `Athan Clock`. Listing may still say `com.mutazyounes.prayerathan (unreviewed)`.
4. Or open the opt-in link on the tablet and tap Update / Download.

If Update never appears:

- Debug APK is still installed. Uninstall Athan Clock, then install from the opt-in link.
