...
Owners: Mutaz or engineering. Do these in order.

## Done

- [x] Public listing wanted. Name Athan Clock.
...
- [x] Signed AAB on internal testing. 37 (0.37.0). Testers in store/testers.csv.
...
- [ ] Privacy URL in settings.
- [ ] Persist location. City picker. Drop unused GPS perms or request at tap.
- [ ] One exact-alarm permission. Hide athan UI preview.
- [ ] Copy licensed MP3s to `res/raw`.
- [ ] Closed testing Alpha: countries, testers, promote the AAB, send for review.
- [ ] Advertising ID, FGS demo, exact-alarm demo in App content.
- [ ] Apply for production after 12/14 is green.

## After it is live

- [ ] Uninstall debug on the wall tablets. Install from Play.
